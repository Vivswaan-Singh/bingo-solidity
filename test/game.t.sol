...
contract BingoTest is Test {
    ...
    function setUp() public {
        ...
        bingo = new Game(coinAddress, 178);
    ...
    function test_joinGameBeingPlayed() public {
        ...
        uint256 turnDuration = Game(gameAddress).getTurnDuration();
    ...
    function test_play(uint256 iters) public {
        ...
        for(uint256 i=0; i < 1000 && winner == address(0);){
            vm.warp(currTime);
            vm.prank(addr1);
    ...
    function test_updateEntryFees(uint256 fee) public {
        ...
        vm.startPrank(addr1);
        Game currGame = new Game(coinAddress, 178);
